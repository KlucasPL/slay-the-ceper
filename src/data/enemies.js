...
export const enemyLibrary = {
  cepr: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Złość turysty', damage: 11, hits: 1 },
    ],
  },
  zagubiony_ceper: {
    id: 'zagubiony_ceper',
  ...
  influencerka: {
    ...
    pattern: [
      { type: 'attack', name: 'Selfie z zaskoczenia', damage: 13, hits: 1, applyVulnerable: 2 },
  ...
  konik_spod_kuznic: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Priorytet VIP', damage: 11, hits: 1, applyWeak: 1 },
    ],
  },
  ...
  turysta_w_klapkach: {
    ...
    patternType: 'loop',
    pattern: [
      { type: 'attack', name: 'Rzut kabanosem', damage: 10, hits: 1 },
      { type: 'attack', name: 'Plask klapkiem', damage: 7, hits: 2, applyFrail: 1 },
      { type: 'attack', name: 'Otarcia pięty', damage: 13, hits: 1 },
    ],
  },
  rodzina_z_glosnikiem: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Zgubione dziecko', damage: 7, hits: 2, applyWeak: 1 },
      { type: 'attack', name: 'Krzyk o loda', damage: 11, hits: 1 },
    ],
  },
  spocony_polmaratonczyk: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Pot na czole', damage: 8, hits: 1 },
      { type: 'attack', name: 'Ślepa szarża', damage: 13, hits: 1 },
    ],
  },
  insta_taterniczka: {
    ...
    patternType: 'loop',
    pattern: [
      { type: 'attack', name: 'Błysk flesza', damage: 8, hits: 1, applyVulnerable: 2 },
      { type: 'status', name: 'Selfie z hasztagiem', addStatusCard: 'spam_tagami', amount: 3 },
      { type: 'attack', name: 'Selfie z widokiem', damage: 11, hits: 1 },
  ...
  janusz_znawca_szlakow: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Dobra rada', damage: 8, hits: 1, applyWeak: 2 },
      { type: 'attack', name: 'Wykład o mapie', damage: 11, hits: 1 },
    ],
  },
  zlodziejska_kaczka: {
    ...
    patternType: 'loop',
    pattern: [
      { type: 'attack', name: 'Uszczypnięcie', damage: 6, hits: 2 },
      { type: 'block', name: 'Unik wodny', block: 11, gainEvasion: 1 },
      { type: 'attack', name: 'Kradzież kanapki', damage: 9, hits: 1, stealCard: true },
    ],
  },
  glodny_swistak: {
    id: 'glodny_swistak',
    ...
    patternType: 'loop',
    pattern: [
      { type: 'attack', name: 'Krótki pazur', damage: 6, hits: 2, applyWeak: 1 },
      { type: 'buff', name: 'Pisk rozpaczy', strengthGain: 2, block: 6 },
      { type: 'attack', name: 'Ucieczka w nory', damage: 9, hits: 1, applyFrail: 1 },
    ],
  },
  ...
  bileter_z_tpn: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Inspekcja paragonu', damage: 13, hits: 1, applyWeak: 1 },
      { type: 'buff', name: 'Wezwanie straży', strengthGain: 2, block: 16 },
      { type: 'attack', name: 'Mandat za wydeptanie', damage: 16, hits: 1, applyFrail: 1 },
    ],
  },
  meleksiarz_pirat_drogowy: {
    ...
    elite: true,
    pattern: [
      { type: 'attack', name: 'Boczkiem, boczkiem!', damage: 5, hits: 2, applyVulnerable: 1 },
      { type: 'attack', name: 'Klakson z zaskoczenia', damage: 10, hits: 1, applyFrail: 1 },
      { type: 'attack', name: 'Wjazd w tłum', damage: 15, hits: 1 },
      { type: 'attack', name: 'Priorytet dla meleksa', damage: 6, hits: 2, applyVulnerable: 1 },
    ],
  },
  bober_z_morskiego_oka: {
    ...
    pattern: [
      ...
      { type: 'attack', name: 'Plask ogonem', damage: 14, hits: 1 },
      { type: 'attack', name: 'Podgryzanie kijka', damage: 7, hits: 1, applyFrail: 2 },
