...
export const enemyLibrary = {
  ...
  boss: {
    ...
    isBoss: true,
    pattern: [
      { type: 'buff', name: 'Górski Ryk', strengthGain: 1, block: 8 },
      { type: 'attack', name: 'Agresywne pozowanie', damage: 3, hits: 3 },
      { type: 'attack', name: 'Podatek od zdjęcia', damage: 13, hits: 1, applyFrail: 1 },
      { type: 'attack', name: 'Uścisk Krupówek', damage: 17, hits: 1 },
    ],
  },
};
