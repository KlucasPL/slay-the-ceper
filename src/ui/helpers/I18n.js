...
const UI_TRANSLATIONS = {
  ...
  en: {
    ...
    'combat.relicsLabel': 'Souvenirs:',
    'combat.relicsAria': 'Collected Souvenirs',

    'library.title': 'Tatra Library',
    'library.subtitle': 'Cards and souvenirs from this Tatra expedition.',
    'library.tabCards': 'Cards',
    'library.tabRelics': 'Souvenirs',
