...
const REPLACEMENTS = [
  ...
  [/\bdutków\b/g, 'Dutki'],
  [/\bdutki\b/g, 'Dutki'],
  [/\bPamiątki\b/g, 'Souvenirs'],
  [/\bPamiątka\b/g, 'Souvenir'],
  [/\bWybierz\b/g, 'Choose'],
  ...
  [/\bKup Pamiątki\b/g, 'Buy Souvenirs'],
  ...
  [/Zgarnij Pamiątkę/g, 'Claim Souvenir'],
  ...
  [/Kupiono pamiątkę:/g, 'Souvenir purchased:'],
  [/Ni mos tela dutków, synek!/g, 'Not enough Dutki, pal!'],
  [/To już wykupione\./g, 'Already purchased.'],
  [/Tej pamiątki nie ma\./g, 'This souvenir is not available.'],
